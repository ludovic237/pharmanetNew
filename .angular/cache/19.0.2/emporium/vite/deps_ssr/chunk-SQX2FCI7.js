...
var FlexOffsetDirective = class _FlexOffsetDirective extends BaseDirective2 {
  constructor(elRef, directionality, styleBuilder, marshal, styler) {
    ...
    if (this.parentElement) {
      this.marshal.trackValue(this.parentElement, "layout-gap").pipe((0, import_operators.takeUntil)(this.destroySubject)).subscribe(this.triggerUpdate.bind(this));
    }
  }
  // *********************************************
  // Protected methods
...
var FlexDirective = class _FlexDirective extends BaseDirective2 {
  ...
  ngOnInit() {
    if (this.parentElement) {
      this.marshal.trackValue(this.parentElement, "layout").pipe((0, import_operators.takeUntil)(this.destroySubject)).subscribe(this.onLayoutChange.bind(this));
      this.marshal.trackValue(this.nativeElement, "layout-align").pipe((0, import_operators.takeUntil)(this.destroySubject)).subscribe(this.triggerReflow.bind(this));
    }
  }
  /**
...
var LayoutAlignDirective = class _LayoutAlignDirective extends BaseDirective2 {
  constructor(elRef, styleUtils, styleBuilder, marshal) {
    ...
    this.inline = false;
    this.init();
    this.marshal.trackValue(this.nativeElement, "layout").pipe((0, import_operators.takeUntil)(this.destroySubject)).subscribe(this.onLayoutChange.bind(this));
  }
  // *********************************************
  // Protected methods
  // *********************************************
...
var LayoutGapDirective = class _LayoutGapDirective extends BaseDirective2 {
  ...
  constructor(elRef, zone, directionality, styleUtils, styleBuilder, marshal) {
    ...
    this.observerSubject = new import_rxjs.Subject();
...
@ngbracket/ngx-layout/fesm2022/ngbracket-ngx-layout-flex.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-SQX2FCI7.js.map
