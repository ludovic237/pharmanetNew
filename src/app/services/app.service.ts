...
export class AppService {
  ...
  public addToCompare(product: Product) {
    let message, status;
    if (this.Data.compareList.filter((item:any) => item.id == product.id)[0]) {
  ...
  public addToWishList(product: Product) {
    let message, status;
    if (this.Data.wishList.filter((item:any) => item.id == product.id)[0]) {
  ...
  public addToCart(product: Product) {
    ...
    if (this.Data.cartList.filter((item:any) => item.id == product.id)[0]) {
      let item = this.Data.cartList.filter((item:any) => item.id == product.id)[0];
      item.cartCount = product.cartCount;
    } else {
      this.Data.cartList.push(product);
    }
    this.Data.cartList.forEach((product:any) => {
  ...
  public resetProductCartCount(product: Product) {
    product.cartCount = 0;
    let compareProduct = this.Data.compareList.filter((item:any) => item.id == product.id)[0];
    if (compareProduct) {
      compareProduct.cartCount = 0;
    }
    ;
    let wishProduct = this.Data.wishList.filter((item:any) => item.id == product.id)[0];
    if (wishProduct) {
  ...
  public getBrands() {
    return [
      ...
      {name: 'dream', image: 'images/brands/dream.png'},
      {name: 'congrats', image: 'images/brands/congrats.png'},
      {name: 'best', image: 'images/brands/best.png'},
      {name: 'original', image: 'images/brands/original.png'},
      {name: 'retro', image: 'images/brands/retro.png'},
      {name: 'king', image: 'images/brands/king.png'},
      {name: 'love', image: 'images/brands/love.png'},
      {name: 'the', image: 'images/brands/the.png'},
      {name: 'easter', image: 'images/brands/easter.png'},
      {name: 'with', image: 'images/brands/with.png'},
      {name: 'special', image: 'images/brands/special.png'},
      {name: 'bravo', image: 'images/brands/bravo.png'}
    ];
  }
  ...
  public getSystem(): Observable<any> {
    return this.http.get<any>(this.url + 'system.json');
  }
