...
export const routes: Routes = [
    ...
    { path: 'product-detail-list', component: ProductDetailListComponent, data: { breadcrumb: 'Product Detail list' } },
    ...
    { path: 'rapport-caisse', component: RapportCaisseComponent, data: { breadcrumb: 'Rapport caisse' } },
