...
@Component({
  ...
  templateUrl: './commande-info-dialog.component.html',
  styleUrl: './commande-info-dialog.component.scss'
})
export class CommandeInfoDialogComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CommandeInfoDialogComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any
  ) {
    this.detailForm = this.fb.group({
      commandeId: data?.commandeId,
      produitCmdId: data?.produitCmdId,
      prixAchat: [data?.prixAchat || 0, [Validators.required, Validators.min(0)]],
      prixVente: [data?.prixVente || 0, [Validators.required, Validators.min(0)]],
      qteRecu: [data?.quantiteRecue || 0, [Validators.required, Validators.min(0)]],
    });
  }
