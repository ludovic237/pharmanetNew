...
export class DetailProduitDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    combineLatest([
      this.ventesService.fetchVentesPageableRangeProduct(
        ...
        null,
        this.produitId + "",
        this.appService.formatDate(new Date(new Date(this.startDateVentes.setHours(0, 0, 0, 0))) + ""),
        this.appService.formatDate(new Date(new Date(this.endDateVentes.setHours(23, 59, 59, 0))) + ""),
        null,
        null,
        null,
        null,
      ...
      this.commandesService.getCommandeInfoByProduct(
        ...
        this.countSorties,
        this.produitId + "",
        this.appService.formatDate(new Date(new Date(this.startDateCommandes.setHours(0, 0, 0, 0))) + ""),
      ...
      this.enrayonsService.getProduitsEnRayonPageableProduitRange(
        ...
        this.produitId + "",
        0 + "",
        this.appService.formatDate(new Date(new Date(this.startDateSorties.setHours(0, 0, 0, 0))) + ""),
        this.appService.formatDate(new Date(new Date(this.endDateSorties.setHours(23, 59, 59, 0))) + ""),
        null,
        null,
        null,
      ),
  ...
  getProduitsEnRayonPageableProduitRange(): void {
    ...
    this.enrayonsService.getProduitsEnRayonPageableProduitRange(
      ...
      this.produitId + "",
      0 + "",
      this.appService.formatDate(new Date(new Date(this.startDateEnRayons.setHours(0, 0, 0, 0))) + ""),
      this.appService.formatDate(new Date(new Date(this.endDateEnRayons.setHours(23, 59, 59, 0))) + ""),
      null,
      null,
      null,
    ).subscribe({
