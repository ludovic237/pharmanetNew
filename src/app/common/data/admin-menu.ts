...
export const adminMenuItems = [
    ...
    new AdminMenu (201, 'ADMIN_NAV.EXTERNAL_LINK', null, 'http://themeseason.com', 'open_in_new', '_blank', false, 0),

  new AdminMenu (202, 'Invoice', '/admin/invoice', null, 'supervisor_account', null, false, 0),
  new AdminMenu (203, 'Housting unit', '/admin/housting-unit', null, 'supervisor_account', null, false, 0),
  new AdminMenu (204, 'Issue', '/admin/issue', null, 'supervisor_account', null, false, 0),
