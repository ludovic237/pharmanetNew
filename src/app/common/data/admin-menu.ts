...
export const adminMenuItems = [
    ...
    new AdminMenu(25, 'ADMIN_NAV.FORMES', '/admin/products/formes', null, 'category', null, false, 20),
    new AdminMenu(26, 'ADMIN_NAV.FABRIQUANTS', '/admin/products/fabriquants', null, 'factory', null, false, 20),
    new AdminMenu(27, 'ADMIN_NAV.RAYONS', '/admin/products/rayons', null, 'store', null, false, 20),
    new AdminMenu(28, 'ADMIN_NAV.MAGASINS', '/admin/products/magasins', null, 'store_mall_directory', null, false, 20),
