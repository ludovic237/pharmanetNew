...
@router.post("/create", response_model=Inventaire)
...
@router.post("/create-new", response_model=Inventaire)
...
@router.put("/update/valid/product/{id}", response_model=ProduitInventaire)
...
@router.get("/terminer/{id}", response_model=Inventaire)
